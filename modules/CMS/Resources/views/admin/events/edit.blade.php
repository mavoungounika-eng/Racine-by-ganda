...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">✏️ Éditer l'événement</h1>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('cms.admin.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="fashion_show" {{ old('type', $event->type) == 'fashion_show' ? 'selected' : '' }}>Défilé de Mode</option>
                                        <option value="exhibition" {{ old('type', $event->type) == 'exhibition' ? 'selected' : '' }}>Exposition</option>
                                        <option value="workshop" {{ old('type', $event->type) == 'workshop' ? 'selected' : '' }}>Atelier</option>
                                        <option value="sale" {{ old('type', $event->type) == 'sale' ? 'selected' : '' }}>Vente Privée</option>
                                        <option value="meeting" {{ old('type', $event->type) == 'meeting' ? 'selected' : '' }}>Rencontre</option>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_free" 
                                               name="is_free" value="1" {{ old('is_free', $event->is_free) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="registration_required" 
                                               name="registration_required" value="1" {{ old('registration_required', $event->registration_required) ? 'checked' : '' }}>
