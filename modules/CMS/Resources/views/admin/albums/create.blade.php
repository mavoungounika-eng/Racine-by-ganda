...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">➕ Créer un album</h1>
            <p class="text-muted mb-0">Créez un nouvel album photo</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('cms.admin.albums.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('album_date') is-invalid @enderror" 
                                           id="album_date" name="album_date" value="{{ old('album_date') }}">
                                    @error('album_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
