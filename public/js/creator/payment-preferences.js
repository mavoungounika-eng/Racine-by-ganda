...
/**
 * Note: Les fonctions utilitaires (formatAmount, validatePhone, showButtonLoader, hideButtonLoader, showNotification)
 * sont désormais disponibles dans Racine.Utils (core/utilities.js)
 * 
 * Usage: Racine.Utils.formatAmount(1000) ou window.Racine.Utils.showNotification('Message', 'success')
 */
