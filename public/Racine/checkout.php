...
<?php
session_start();
include 'config.php'; // ta connexion PDO ou mysqli
...
<html lang="en">
  <head>
    <title>Commande - RACINE BY GANDA</title>
    <meta charset="utf-8">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="shop.html">Boutique</a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-10 ftco-animate">
						<form method="POST" action="place_order.php" id="orderForm" class="billing-form">
...
<select name="country" class="form-control" required>
	...
	<option value="Japan">Japan</option>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input type="text" name="postecodezip" class="form-control" placeholder=""  required>
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
...
// Exemple de calculs (adapter selon ta logique)
...
$delivery = 2000; // en F CFA, ou 0 si livraison gratuite
$discount = 3000; // montant remise, ou 0

// Total = subtotal + delivery - discount
$total = $subtotal + $delivery - $discount;

// Pour un affichage en format monétaire français
...
?>
  ...
  <div class="col-md-6 d-flex">
    <div class="cart-detail cart-total bg-light p-3 p-md-4">
      ...
      <p class="d-flex">
        <span>Livraison</span>
        <span><?= format_price($delivery) ?></span>
      </p>
      <p class="d-flex">
        <span>Remise</span>
  ...
  <div class="col-md-6">
    <div class="cart-detail bg-light p-3 p-md-4">
      ...
      <div class="form-group">
        <div class="col-md-12">
          <div class="radio">
             <label><input type="radio" name="payment_method" class="mr-2" value="check_payment"> Check Payment</label>
          </div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-md-12">
          <div class="checkbox">
             <label><input type="checkbox" name="terms" value="accepted" class="mr-2" id="termsCheckbox"> I have read and accept the terms and conditions</label>
          </div>
        </div>
      </div>
      <button type="submit" id="placeOrderBtn" disabled>Place an order</button>
  ...
  function updateButtonState() {
    ...
    placeOrderBtn.disabled = !(paymentChecked && termsAccepted);
  }
