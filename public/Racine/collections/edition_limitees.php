...
<head>
    <meta charset="UTF-8">
    <title>Collection Editon limitées - RACINE BY GANDA</title>
    <style>
        body {
...
<h1>Collection edition limitée</h1>

<div class="produits">
    <?php
    $sql = "SELECT * FROM produits WHERE collection = 'edition_limitee' ORDER BY id DESC";
